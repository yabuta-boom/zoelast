    ...
    <div className="w-full pt-24">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="responsive-section">
          ...
          {/* Company Stats */}
          <div className="bg-blue-600 rounded-lg p-6 sm:p-12 mb-8 sm:mb-16">
            <div className="responsive-grid-4 text-center text-white">
              <div>
          ...
          <div className="mb-8 sm:mb-16">
            <h2 className="responsive-title text-center mb-8 sm:mb-12">{t('about.values.title')}</h2>
